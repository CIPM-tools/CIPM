...
//		Assertions.assertTrue(ReplaceSingleValuedEAttribute.class.isAssignableFrom(change.getClass()));
		...
		Assertions.assertEquals(pcmCmpName, propagatedRepoCmp.eGet(
				propagatedRepoCmp.eClass().getEStructuralFeature(RepositoryPackage.BASIC_COMPONENT__ENTITY_NAME)));
		...
		Assertions.assertEquals(pcmCmpName, resRepoCmp
				.eGet(resRepoCmp.eClass().getEStructuralFeature(RepositoryPackage.BASIC_COMPONENT__ENTITY_NAME)));
		Assertions.assertTrue(EcoreUtil.equals(resRepoEObj, propagatedRepoEObj));
		...
		Assertions.assertEquals(
				PcmUserInteractionManager.getDesiredFeatureValue(createdCmp[0],
						javaMod.eClass().getEStructuralFeature(CommonsPackage.NAMED_ELEMENT__NAME), true),
				javaMod.eGet(javaMod.eClass().getEStructuralFeature(CommonsPackage.NAMED_ELEMENT__NAME)));

		var inputNss = (List) PcmUserInteractionManager.getDesiredFeatureValue(createdCmp[0],
				javaMod.eClass().getEStructuralFeature(CommonsPackage.NAMESPACE_AWARE_ELEMENT__NAMESPACES), true);
		var javaModNss = (List) javaMod
				.eGet(javaMod.eClass().getEStructuralFeature(CommonsPackage.NAMESPACE_AWARE_ELEMENT__NAMESPACES));
